...
export default {
  setup() {
    ...
    var slideIndex = 1;
    onMounted(() => showSlides(slideIndex));

    function plusSlides(index: number) {
    ...
    return { images, plusSlides, currentSlide, showSlides };
  },
};
</script>
...
img {
  ...
  height: 300px;
  border-radius: 8px;
  box-shadow: 0 6px 15px -2px rgb(112 128 144 / 50%);
}
