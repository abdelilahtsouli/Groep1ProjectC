    ...
    <div>
        ...
        <div class="header-contact">
            ...
            <div class="content">
                ...
                <p>
                Star-shl wil u altijd goed en snel van dienst zijn. Verloopt onze dienstverlening toch niet helemaal zoals u wenst? Laat ons dat dan weten. Dan zoeken wij, samen met u, naar een oplossing. 
                </p>
            </div>
        </div>
    </div>
